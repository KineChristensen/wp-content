            ...
            if ($display > 0 && $c_display > 0) {
                ...
                if ($admin) {
                    ...
                    if ($type == 1) {
	                    ...
	                    if (!$img) { $pic = "<img src='".plugin_dir_url( dirname( __FILE__ ) )."images/no-image.jpg' class='wpgmza_map_image' style=\"height:".$wpgmza_image_height."px; width:".$wpgmza_image_width."px\"\" />";; } else {
                            ...
                            */
                            ...
                            $wpgmza_tmp_body .= "<p class='wpgmza-content-address-holder-inner'><strong><a href=\"javascript:void(0);\" id=\"wpgmaps_marker_$wpgmaps_id\" title=\"".stripslashes($result->title)."\">".stripslashes($result->title)."</a></strong></p>";
                            }
							...
							$wpgmza_tmp_body .= $custom_fields->html();
