...
class VP_ShortcodeGenerator
{
	...
	function print_form($attributes)
	{
		...
		<div class="vp-sc-action">
			<button class="vp-sc-insert button"><?php _e('Insert', 'wp-ultimate-post-grid'); ?></button>
			<button class="vp-sc-cancel button"><?php _e('Cancel', 'wp-ultimate-post-grid') ?></button>
		</div>
		<?php
	}
