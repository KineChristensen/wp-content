...
<a target="_blank" href="http://wordpress.org/extend/plugins/wp-filter-posts/" class="xyz_star">Rate this plugin</a> -
...
<input type="hidden" name="redirActive" value="http://xyzscripts.com/subscription/pending/XYZWPPFL">
<input type="hidden" name="redirPending" value="http://xyzscripts.com/subscription/active/XYZWPPFL">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input class="submit_wpf_new" type="submit" value="Subscribe" name="Submit"  onclick="javascript: if(!verify_fields()) return false; " />
