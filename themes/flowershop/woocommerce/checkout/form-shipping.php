...
<div class="woocommerce-shipping-fields">
	...
	<?php if ( true === WC()->cart->needs_shipping_address() ) : ?>
		...
		<legend class="heading-with-border"><b><?php _e( 'Shipping Address', 'flowershop' ); ?></b></legend>

		<div class="checkbox">

			<label for="ship-to-different-address-checkbox" class="checkbox" id="ship-to-different-address">
				...
				<?php _e( 'Ship to a different address?', 'flowershop' ); ?>
			</label>
